return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>m", "<cmd>lua require('harpoon.mark').add_file()<CR>", { desc = "Add file to Harpoon" }) -- Add file to Harpoon
    keymap.set("n", "<C-e>", "<cmd>lua require('harpoon.ui').toggle_quick_menu()<CR>", { desc = "Toggle Harpoon menu" }) -- Toggle Harpoon menu
